...
namespace RequireConfirmedEmail.Services
{
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        /// <summary>
        /// Validates that an email confirmation token matches the specified <paramref name="user"/> and if successful sets
        /// EmailConfirmed to true and if UnconfirmedEmail is not NULL or Empty, copies the user's UnconfirmedEmail to user's
